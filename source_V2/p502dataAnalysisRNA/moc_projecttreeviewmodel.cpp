...
static const char qt_meta_stringdata_projectTreeViewModel[] = {
    "projectTreeViewModel\0"
};
...
const QMetaObjectExtraData projectTreeViewModel::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject projectTreeViewModel::staticMetaObject = {
    { &QAbstractItemModel::staticMetaObject, qt_meta_stringdata_projectTreeViewModel,
      qt_meta_data_projectTreeViewModel, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &projectTreeViewModel::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_projectTreeViewModel))
