...
static const char qt_meta_stringdata_resultTableView[] = {
    "resultTableView\0findRow()\0\0"
    "displayCounts(QString)\0fileName\0"
    "updateCounts(QString)\0removeCounts(QString)\0"
};
...
const QMetaObjectExtraData resultTableView::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject resultTableView::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_resultTableView,
      qt_meta_data_resultTableView, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &resultTableView::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_resultTableView))
