...
static const char qt_meta_stringdata_readMapper[] = {
    "readMapper\0producerFinished()\0\0"
    "runCanceled()\0"
};
...
const QMetaObjectExtraData readMapper::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject readMapper::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_readMapper,
      qt_meta_data_readMapper, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &readMapper::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_readMapper))
