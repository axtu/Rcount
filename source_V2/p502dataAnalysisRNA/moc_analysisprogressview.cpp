...
static const char qt_meta_stringdata_analysisProgressView[] = {
    "analysisProgressView\0analysisCanceled()\0"
    "\0updateProgress(int)\0progressIN\0"
    "updateStatus(QString)\0statusIN\0"
};
...
const QMetaObjectExtraData analysisProgressView::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject analysisProgressView::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_analysisProgressView,
      qt_meta_data_analysisProgressView, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &analysisProgressView::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_analysisProgressView))
